...
const StatsSection: React.FC<StatsProps> = ({
  ...
  return (
    <section className="py-16 bg-emerald-50 dark:bg-emerald-950/10 dark:hover:glow-effect dark:relative dark:z-10">
      <div className="max-w-7xl mx-auto px-4">
        <div className="w-full h-[300px] bg-emerald-900 relative overflow-hidden rounded-xl">
          {/* Decorative elements */}
