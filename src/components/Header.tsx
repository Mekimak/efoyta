              ...
              <React.Fragment>
                ...
                <div className="hidden md:block">
                  <Button
                    ...
                    className="bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-700 hover:to-emerald-800 text-white transition-all duration-300 shadow-md hover:shadow-lg dark:shadow-emerald-900/20 dark:hover:shadow-emerald-900/40 luxury-button"
                  >
          ...
          {isMobileMenuOpen && (
            ...
            >
              <div className="max-w-7xl mx-auto px-6 py-4 space-y-4">
                ...
                >
                  <Search className="inline-block h-4 w-4 mr-2" /> Property
                  Search
                </Link>
                {user ? (
                  <>
                    <Link
                      ...
                      className="block py-2 text-emerald-800 dark:text-emerald-100 hover:text-emerald-600 dark:hover:text-emerald-400"
                    >
                      <User className="inline-block h-4 w-4 mr-2" /> Dashboard
                    </Link>
                    <button
                      onClick={handleLogout}
                      className="block w-full text-left py-2 text-emerald-800 dark:text-emerald-100 hover:text-emerald-600 dark:hover:text-emerald-400"
                    >
                  ...
                  <>
                    ...
                    <Link
                      ...
                      className="block py-2 text-emerald-800 dark:text-emerald-100 hover:text-emerald-600 dark:hover:text-emerald-400"
                    >
                      <User className="inline-block h-4 w-4 mr-2" /> Sign Up
                    </Link>
                  </>
                )}
              </div>
